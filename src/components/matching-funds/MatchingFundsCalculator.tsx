  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8 animate-fade-in">
      ...
      <Alert>
        ...
        <AlertDescription>
          Public matching funds programs help amplify the impact of small-dollar contributions to qualifying candidates.
          Different offices have different matching ratios and maximum matchable amounts.
        </AlertDescription>
      </Alert>
