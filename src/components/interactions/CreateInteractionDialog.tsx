...
const InteractionDialogContent = ({
  onSuccess,
}: {
  onSuccess: () => void;
}) => {
  ...
  const { selectedVoter, type, notes, setSelectedVoter, setType, setNotes } = useVoterInteraction();
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        ...
        <VoterInteractionProvider>
          <InteractionDialogContent onSuccess={onSuccess} />
        </VoterInteractionProvider>
      </DialogContent>
    </Dialog>
  );
